...
public class ShepherdsPiesDbContext : IdentityDbContext<IdentityUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PizzaTopping>().HasData(new PizzaTopping[]
        {
            ...
            new PizzaTopping {Id = 6, PizzaId = 3, ToppingId = 1, Quantity = 7},
            new PizzaTopping {Id = 7, PizzaId = 4, ToppingId = 1, Quantity = 9},
            new PizzaTopping {Id = 8, PizzaId = 5, ToppingId = 1, Quantity = 12},
            new PizzaTopping {Id = 9, PizzaId = 5, ToppingId = 1, Quantity = 15},
            new PizzaTopping {Id = 10, PizzaId = 5, ToppingId = 1, Quantity = 7},
            new PizzaTopping {Id = 11, PizzaId = 6, ToppingId = 1, Quantity = 7},
            new PizzaTopping {Id = 12, PizzaId = 6, ToppingId = 1, Quantity = 4},
            new PizzaTopping {Id = 13, PizzaId = 7, ToppingId = 1, Quantity = 10},
            new PizzaTopping {Id = 14, PizzaId = 8, ToppingId = 1, Quantity = 11},
            new PizzaTopping {Id = 15, PizzaId = 9, ToppingId = 1, Quantity = 12},
            new PizzaTopping {Id = 16, PizzaId = 9, ToppingId = 1, Quantity = 10},
            new PizzaTopping {Id = 17, PizzaId = 10, ToppingId = 1, Quantity = 5},
            new PizzaTopping {Id = 18, PizzaId = 11, ToppingId = 1, Quantity = 6},
            new PizzaTopping {Id = 19, PizzaId = 11, ToppingId = 1, Quantity = 8},
            new PizzaTopping {Id = 20, PizzaId = 11, ToppingId = 1, Quantity = 7},
            new PizzaTopping {Id = 21, PizzaId = 12, ToppingId = 1, Quantity = 8},
            new PizzaTopping {Id = 22, PizzaId = 12, ToppingId = 1, Quantity = 9},
            new PizzaTopping {Id = 23, PizzaId = 13, ToppingId = 1, Quantity = 10},
            new PizzaTopping {Id = 24, PizzaId = 14, ToppingId = 1, Quantity = 10},
            new PizzaTopping {Id = 25, PizzaId = 15, ToppingId = 1, Quantity = 7},
            new PizzaTopping {Id = 26, PizzaId = 15, ToppingId = 1, Quantity = 8}
        });
